    ...
    { id: 9, type: "game", p: 85, icon: '🦾', source: "Deus Ex", ar: { name: "آدم جينسن", ability: "التسلل التقني", lore: "مزيجٌ بين البشر═ والآلة═، يتسلل️ كالظل═ عبرَ الحصون═. يكشف️ الأسرارَ التي أرادَ العالم️ دفنَها." }, en: { name: "ADAM JENSEN", ability: "Augmented Infiltration", lore: "A fusion of man and machine, slipping through fortresses like a shadow. He unearths secrets the world intended to bury." } },
    ...
    { id: 140, type: "anime", p: 86, icon: '⚔️', source: "Fairy Tail", ar: { name: "إرزا سكارلت", ability: "تيتانيا", lore: "أقوى امرأة في نقابة الخرافة، ملكة السيوف التي لا ت️قهر." }, en: { name: "ERZA SCARLET", ability: "Titania", lore: "The strongest woman in Fairy Tail, the unbeatable queen of swords." } },
    ...
    { id: 300, type: "anime", p: 85, icon: '🥊', source: "Kengan Ashura", ar: { name: "أوما توكيتا", ability: "أسد القرن", lore: "المقاتل الأسطوري الذي يملك تقنية القرن. لا ي️هزم في الكاراتيه." }, en: { name: "OHMA TOKITA", ability: "Advance", lore: "The legendary fighter wielding Niko Style, undefeated in combat." } },
