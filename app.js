...
${winners[0].ico} ${winners[0].name} فاز بالبطولة!`);
    ...
    async function gzRenderComments(key) {
        ...
        if (!sec) return;
        sec.innerHTML = `<div class="gz-cmt-hdr">💬 سجل المحاربين</div><div class="gz-cmt-list"><div class="gz-cmt-empty">⏳ جاري التحميل...</div></div>`;
        ...
        sec.innerHTML = `
            ...
            <div class="gz-cmt-list">${listHTML}</div>
