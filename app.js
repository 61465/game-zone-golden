    ...
    { id: 127, type: "anime", p: 84, icon: '⚡', source: "My Hero Academia", ar: { name: "إيزوكو ميدوريا", ability: "ون فور أول", lore: "الولد الذي ولد بلا قدرة لكن أصبح رمز السلام." }, en: { name: "IZUKU MIDORIYA", ability: "One For All", lore: "The quirkless boy who became the symbol of peace." } },
    ...
    { id: 149, type: "anime", p: 104, isPeak: true, icon: '⚡', source: "Bleach", ar: { name: "إيتشيغو (البنكاي النهائي)", ability: "قوة الشينيغامي", lore: "إيتشيغو بعد دمج جميع قواه في بنكاي واحد لا يقهر." }, en: { name: "ICHIGO (Final Bankai)", ability: "Shinigami Power", lore: "Ichigo after merging all his powers into one unbeatable Bankai." } },
    ...
    { id: 191, type: "comic", p: 109, isPeak: true, icon: '⚡', source: "DC", ar: { name: "ذا بريزنس", ability: "الوجود", lore: "الوجود الأعلى في عالم DC — الخالق الذي لا يحصى." }, en: { name: "THE PRESENCE", ability: "Presence", lore: "The supreme being in the DC universe — the Creator beyond description." } },
    ...
    { id: 249, type: "anime", p: 89, icon: '⚡', source: "The Rising of the Shield Hero", ar: { name: "ناوفومي إواتاني", ability: "بطل الدرع", lore: "بطل الدرع المخان الذي يبني إمبراطورية من الصفر." }, en: { name: "NAOFUMI IWATANI", ability: "Shield Hero", lore: "The betrayed Shield Hero who builds an empire from nothing." } },
